  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        {
          title: "Толбухин маяк",
          description: "Один из старейших российских маяков, построенный по приказу Петра I. Установлен на искусственном каменистом островке площадью 70 на 70 метров, лежащем в 2,8 мили к WNW от западной оконечности острова Котлин. Можно доехать на лодке!",
          width: "60.042590",
          longitude: "29.542446",
          status: 'approved',
          userId: 2,
